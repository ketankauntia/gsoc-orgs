...
tldr: "To apply for GSoC, verify the current rules, follow the official timeline, research accepted organizations, use each community's published channel, complete any prerequisites, develop a project proposal with mentor feedback and upload the final PDF through the GSoC web application before the UTC deadline. Email or a repository pull request alone is not an application."
keyTakeaways:
  - Apply through the official GSoC web application during the contributor window; organizations cannot replace that submission for you.
  - Research three to five accepted organizations, then deepen work with one or two whose mission, project and contribution process fit.
  - Organization-specific templates, contribution tasks and AI rules are binding even when they are not universal Google requirements.
  - Submit a useful draft early, keep a local final copy and finish well before the deadline because Google does not grant proposal-deadline extensions.
  - "Treat every phase as an artifact to verify: eligibility record, shortlist, contribution evidence, proposal PDF and submission confirmation."
faqs:
  - q: "Where do I apply for GSoC?"
    a: "Register and submit the proposal through the official GSoC website during the contributor application period. Sending a proposal only by email, chat or a repository link does not satisfy the official submission requirement."
  - q: "Can I apply to GSoC without making a pull request?"
    a: "Google has no universal merged-PR quota, but each organization may require a pull request, issue, test task or prior discussion. Follow the current instructions for the organization and project you choose."
  - q: "How many GSoC proposals can I submit?"
    a: "The current FAQ permits up to three proposals, but only one can be accepted. Google's applicant advice recommends concentrating on one or two strong applications rather than treating the process like a lottery."
  - q: "Can I edit a GSoC proposal after submitting it?"
...
The current process is documented in the official [timeline](https://developers.google.com/open-source/gsoc/timeline), [FAQ](https://developers.google.com/open-source/gsoc/faq), [Get Started page](https://summerofcode.withgoogle.com/get-started), [applicant advice](https://developers.google.com/open-source/gsoc/help/student-advice) and [proposal guide](https://google.github.io/gsocguides/student/writing-a-proposal). The workflow below was verified on August 12, 2026. Dates and portal fields must be reopened for each new edition.

:::callout Application versus preparation
...
Use the detailed [GSoC eligibility decision tree](/blog/post/gsoc-eligibility), then save a short eligibility record:
...
Formal eligibility does not mean an organization will select the proposal. It prevents a known rule failure so you can spend the rest of the process on project and community fit. If the roles remain confusing, read [what GSoC is](/blog/post/what-is-gsoc) before proceeding.
...
As of August 12, 2026, Google had not published the official 2027 timeline. The [GSoC 2027 guide](/blog/post/gsoc-2027-guide) keeps estimates separate from announcements. When a new calendar appears, copy the dates into your own UTC-first plan with reminders, but retain the official page as the source of truth.
...
The [GSoC organizations list](/blog/post/gsoc-organizations-list) and [organization-choice scorecard](/blog/post/how-to-choose-gsoc-organization) support discovery, but the official program page and current organization documentation decide application status.
...
1. the project or problem you researched;
2. the repository pages, issue or code path you inspected;
3. what you tried or learned;
4. one focused question whose answer changes your next action.
...
Requirements can change during the research period. Reopen the idea page before final submission. The [first-contribution guide](/blog/post/how-to-start-open-source-for-gsoc) covers repository setup, issue selection, implementation and review without treating PR count as a selection formula.
...
Use the [GSoC proposal guide](/blog/post/how-to-write-gsoc-proposal) to review each section. Do not copy a historical accepted proposal: its project, organization rules, schedule and applicant evidence belong to another decision. Do not use AI-generated text unless the organization permits it, and never submit work you cannot explain and defend.
...
1. Export the proposal in the required PDF format and open the exported file yourself.
2. Check page order, tables, diagrams, text selection, URLs and organization-specific length rules.
3. Upload it through the correct official application entry for the correct organization and project.
4. Complete all required web fields accurately.
5. Reopen or preview the submitted record and verify that the intended file is attached.
6. Save a local final copy, timestamp and confirmation without exposing private data.
7. Finish before your personal target, not at the official final minute.
