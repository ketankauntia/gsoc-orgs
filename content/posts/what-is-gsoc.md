...
tldr: "Google Summer of Code is a global, online program that helps students and other eligible open-source beginners work on scoped software projects with established open-source organizations and community mentors. Google operates the program and funds eligible stipends, but contributors are not Google interns or employees."
keyTakeaways:
  - GSoC connects eligible beginners with open-source organizations; it is not a Google internship, job or recruiting program.
  - Organizations define project ideas and choose proposals they can mentor, while community members guide accepted contributors.
  - Current projects are scoped at about 90, 175 or 350 hours and may use flexible schedules rather than one universal weekly timetable.
  - A stipend depends on the current year's rules, location, project size and successful evaluations; acceptance alone does not make every payment unconditional.
  - The practical first step is to verify eligibility, build open-source readiness and research several communities before writing a proposal.
faqs:
  - q: "What is GSoC in simple words?"
    a: "GSoC is an online program in which eligible students and open-source beginners propose a software project to a participating open-source organization. If selected, they work with community mentors, submit evaluations and may receive an evaluation-linked stipend from Google."
  - q: "Is GSoC a Google internship?"
    a: "No. Google's official FAQ says contributors are independent developers, not Google employees or interns and not employees of the mentoring organization. Describe the program and organization accurately on a resume."
  - q: "Do you have to be a university student to join GSoC?"
...
That definition separates three ideas people often mix together: the program is run by Google, the technical work belongs to an open-source community, and the contributor remains an independent participant. The [official GSoC FAQ](https://developers.google.com/open-source/gsoc/faq), [How It Works page](https://summerofcode.withgoogle.com/how-it-works/) and [Contributor Guide](https://google.github.io/gsocguides/student/) are the primary sources for those roles.
...
If you are deciding whether the program applies to you, start with the current [GSoC eligibility guide](/blog/post/gsoc-eligibility). If you already understand the rules and want the operational steps, use the [application process and checklist](/blog/post/how-to-apply-for-gsoc).
...
The exact dates change each year, but the process has recognizable stages. The [official timeline](https://developers.google.com/open-source/gsoc/timeline) is the live source; never rely on a copied calendar after a new cycle begins.
...
For a concrete benchmark, the 2026 organization list was announced on February 19, contributor applications ran from March 16 to March 31 at 18:00 UTC, accepted projects were announced April 30, community bonding ran in May and coding began May 25. Those are 2026 facts, not a confirmed 2027 calendar. As of August 12, 2026, no official 2027 dates or accepted organizations have been announced; the maintained [GSoC 2027 guide](/blog/post/gsoc-2027-guide) separates confirmed information from planning estimates.
...
1. **Community fit:** Do the mission, communication style, contribution process and long-term work interest you?
2. **Project fit:** Can you understand the problem, build the prerequisites, propose measurable outcomes and complete the core scope?

Use the historical [GSoC organizations list](/blog/post/gsoc-organizations-list) to discover communities and patterns, but verify the current accepted list and current idea pages on the official GSoC site. Past participation does not confirm future selection. The [organization-choice framework](/blog/post/how-to-choose-gsoc-organization) provides a scorecard for turning a broad list into defensible research.
...
For the standard 2026 payment schedule, the [official stipend page](https://developers.google.com/open-source/gsoc/help/student-stipends) lists 45% after the first successful evaluation and 55% after the final successful evaluation. A longer schedule changes evaluation and payment timing. Provider availability, identity checks, residency evidence, fees and tax obligations can also affect what ultimately arrives and when.

The separate [GSoC stipend guide](/blog/post/gsoc-stipend) shows the current table, worked payment calculations, India example and the facts that must be rechecked for 2027. Do not treat an old amount, converted currency screenshot or community post as a current promise.
...
If most answers are no, that is a preparation signal rather than a reason to fake confidence. The [GSoC preparation roadmap](/blog/post/gsoc-preparation-roadmap) converts each gap into a milestone and evidence log.

## First steps from curiosity to a real application

Start in this order:

1. Read the current FAQ, rules and timeline rather than relying on social-media summaries.
2. Complete the eligibility decision tree, including age, beginner or student status, residence and prior roles.
3. Build one practical technical stack plus Git, testing, debugging and command-line fluency.
4. Research three to five accepted organizations when the current list is available; narrow only after inspecting repositories and communication.
5. Follow each organization's contribution and AI policies before doing prerequisite work.
6. Discuss a specific project problem through the published channel and submit an early, compliant proposal through the official site.

The full [how-to-apply guide](/blog/post/how-to-apply-for-gsoc) assigns an artifact and failure check to every phase. For proposal content, use the [evidence-based proposal guide](/blog/post/how-to-write-gsoc-proposal) instead of copying an old accepted PDF.
