...
tldr: "The 2026 GSoC stipend depends on project size and the contributor's country of residence during coding. Published totals range from USD 750 to 1,650 for small projects, USD 1,500 to 3,300 for medium projects and USD 3,000 to 6,600 for large projects, with 45% and 55% installments after successful evaluations on the standard schedule."
keyTakeaways:
  - The stipend is a project total adjusted through purchasing-power parity, not one worldwide monthly salary.
  - For 2026, India totals are USD 750 for small, USD 1,500 for medium and USD 3,000 for large projects.
  - Standard 2026 payments are split 45% after the first successful evaluation and 55% after the final successful evaluation.
  - Project extensions change evaluation and payment timing; they do not automatically increase the project's total hours or stipend.
  - Currency conversion, provider fees and taxes can change the net amount, so use official documents and qualified local advice.
faqs:
  - q: "How much is the GSoC stipend in 2026?"
    a: "The total depends on project size and the contributor's country of residence during coding. The published global ranges are USD 750-1,650 for small, USD 1,500-3,300 for medium and USD 3,000-6,600 for large projects. Check the official country table for the exact total."
  - q: "What is the GSoC stipend in India for 2026?"
    a: "The official 2026 table lists USD 750 for a small project, USD 1,500 for a medium project and USD 3,000 for a large project for a contributor residing in India during the coding period. These are USD totals before any applicable conversion, fees or taxes."
  - q: "Is the GSoC stipend paid monthly?"
...
This is annual information. The figures, provider, location rules, deadlines and payment dates below were verified on August 12, 2026 against Google's [2026 stipend table](https://developers.google.com/open-source/gsoc/help/student-stipends), [Payoneer instructions](https://developers.google.com/open-source/gsoc/help/payoneer), [tax-form guidance](https://developers.google.com/open-source/gsoc/help/tax-forms) and [accepted-contributor information](https://developers.google.com/open-source/gsoc/help/accepted-students). They are not promises for 2027.

:::callout Amount versus money received
...
Before comparing money, confirm that you meet the current [GSoC eligibility rules](/blog/post/gsoc-eligibility). A person must be eligible to receive a stipend, complete the official provider process and pass the relevant evaluations. Selection by itself is not a reason to spend money in advance or count every installment as received.
...
Project size should be selected through feasible deliverables, not by choosing the largest stipend column. The upcoming [project-choice and scoping guide](/blog/post/how-to-choose-gsoc-project) separates core work, stretch work and risks so that a size reflects the project rather than the desired payment.
...
1. **First successful evaluation:** 45% of the total, listed for payment on July 11 for a standard 12-week project.
2. **Final successful evaluation:** the remaining 55%, listed for payment on September 1 for a standard 12-week project.
...
check: first installment + final installment = official total
```

For example, suppose a country's medium-project row is USD 2,400. The first calculation is `2,400 x 0.45 = 1,080`, and the second is `2,400 x 0.55 = 1,320`. Together they return USD 2,400. Both values are gross USD calculations before any other deductions or conversion.
...
The [GSoC evaluations and work-product guide](/blog/post/gsoc-evaluations-work-product) explains midpoint and final evidence, feedback, failures and the final public link. It should be read as an execution guide, not a strategy for doing the minimum needed to trigger payment.
...
Use the [GSoC 2027 guide](/blog/post/gsoc-2027-guide) for announcement status and the [application guide](/blog/post/how-to-apply-for-gsoc) for the annual process. When the new cycle publishes terms, update these fields together rather than changing only the year in the title.
