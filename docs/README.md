...
- `api/` - API reference, API architecture, and endpoint testing notes.
- `blog/` - blog authoring and content-system documentation.
...
- `legacy/` - older generated or HTML documentation kept for reference.

Root-level `README.md`, `CONTRIBUTING.md`, `LICENSE`, and `SECURITY.md` stay at the repository root for GitHub and contributor visibility.
